...
# :runnig: Ideias que ainda vou implementar:
...
* Estratificar todas as folhas de estilo - Deixar a estilização da aplicação mais organizada, separando todas as folhas de estilo por página ou seção;
